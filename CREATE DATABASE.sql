...
CREATE TABLE [Score] (
    ...
    CONSTRAINT [FK_Score_Level] FOREIGN KEY ([level]) REFERENCES [Level] ([levelName]),
    CONSTRAINT [FK_Score_Player] FOREIGN KEY ([playerID]) REFERENCES [Player] ([playerID]) ON DELETE CASCADE
);
...
CREATE TABLE [Floor] (
    ...
    CONSTRAINT [FK_Floor_Level] FOREIGN KEY ([level]) REFERENCES [Level] ([levelName]) ON DELETE CASCADE
);
...
CREATE TABLE [Object] (
    ...
    CONSTRAINT [FK_Object_Level] FOREIGN KEY ([level]) REFERENCES [Level] ([levelName]) ON DELETE CASCADE
);